...
const Hjem = () => {
  return (
    <div className="relative w-full h-screen flex items-center justify-center">
      {/* Video Arka Plan */}
      <div className="video-container flex items-center justify-center rounded-lg overflow-hidden">
        ...
        <div className="absolute z-10 flex flex-col items-center text-white text-center">
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-semibold mb-10 text-lime-300">
            Innovative Webcrafters
          </h1>
          <div className="w-full px-4">
            <p className="text-xs sm:text-2xl md:text-xl lg:text-3xl xl:text-4xl 2xl:text-4xl text-left font-bold text-lime-200">
